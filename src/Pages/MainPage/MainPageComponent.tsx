...
const MainPageComponent: React.FC = (): JSX.Element => {
    ...
    return (
        <>
            ...
            <ul className={classes.listNavigation} style={{ marginBottom: '50px' }}>
                <li>a</li>
                <li>a</li>
                <li>a</li>
                <li>a</li>
            ...
            <h3 style={{ marginBottom: '25px' }}>Подборки</h3>
            ...
            <h3 style={{ margin: '25px 0 16px 0' }}>Как сделать заказ</h3>
            <div className={classes.secondP}>
                <p><b style={{
                    fontWeight: 700
                }}>Выгодные цены: </b> мы постоянно анализируем рынок и предлагаем только самые выгодные предложения наших партнеров.</p>
